...
#             plot_cx=plt.plot(np.multiply(c_x,value_x),all_Y_0_values[index],'o')

        np.save('trader_continuation_time_1_levels_changing_c_x_t12.npy',all_Y_0_values)
#        np.save('value_cx',np.multiply(c_x,value_x))
