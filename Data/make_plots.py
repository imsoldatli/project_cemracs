...
if __name__ == '__main__':
    ...
    #tree_Y_0_values_one=np.load('tree_example_72_one_level_changing_rho.npy')
    #tree_Y_0_values_two=np.load('tree_example_72_two_level_changing_rho.npy')
    ...
    sigma_values=np.load('tree_example_72_sigma_values.npy')
    tree_Y_0_values_one=np.load('tree_example_72_one_level_changing_sigma.npy')
    num_keep=5
    num_sigma=20
    ...
    plt.ylabel('Y_0')
    #plt.legend([tree_1, tree_2, tree_3, grid], ['Tree 1 Level', 'Tree 2 Levels', 'Tree 3 Levels', 'Grid'])
    plt.savefig('tree_example_72_changing_sigma.eps')